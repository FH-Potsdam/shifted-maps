...
import { formatShortDate, formatWeekday } from '../../../utils/formatDate';
  ...
  return (
    <section className={className}>
      ...
      <SliderRange className={classNames({ active: timeSliderActive })}>
        <SliderRangeStart>
          <strong>{formatShortDate(timeSpanStart)}</strong>
          <span>{formatWeekday(timeSpanStart)}</span>
        </SliderRangeStart>
        <SliderRangeEnd>
          <strong>{formatShortDate(timeSpanEnd)}</strong>
          <span>{formatWeekday(timeSpanEnd)}</span>
        </SliderRangeEnd>
      </SliderRange>
    </section>
  );
