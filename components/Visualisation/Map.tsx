...
const MapAttribution = () => (
  <MapAttributionContainer aria-label="Map attribution" role="group">
    <MapboxLogo href="https://www.mapbox.com/" rel="noreferrer" target="_blank">
      Mapbox
    </MapboxLogo>
    <MapAttributionDetails>
      <MapAttributionLinks>
        <a href="https://www.mapbox.com/about/maps" rel="noreferrer" target="_blank">
          © Mapbox
        </a>
        ...
        <span aria-hidden="true">·</span>
        <a href="https://apps.mapbox.com/feedback/" rel="noreferrer" target="_blank">
          Improve this map
        </a>
      </MapAttributionLinks>
      <MapVersion>— Version: {process.env.version}</MapVersion>
    </MapAttributionDetails>
...
const Map = observer(({ children, showTiles, onMapReady, onMapViewChange, onMapZoomStart, ...props }: MapProps) => {
  ...
  const tileUrl = `https://api.mapbox.com/styles/v1/${mapboxStyleId}/tiles/{z}/{x}/{y}?access_token=${mapboxAccessToken}`;
  ...
  return (
    <MapContainer {...props} zoomControl={false} attributionControl={false}>
      ...
      {mapboxAccessToken != null && <MapAttribution />}
...
const MapboxLogo = styled.a`
  ...
  bottom: ${(props) => props.theme.spacingUnit}px;
  z-index: 99999;
  overflow: hidden;
  pointer-events: auto;
...
const MapAttributionDetails = styled.div`
  position: absolute;
...
const MapAttributionLinks = styled.span`
  display: flex;
  flex-wrap: wrap;
  justify-content: flex-end;
  gap: 0 4px;
